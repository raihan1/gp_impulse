<html lang="en">
    <head>
        ...
        <?php echo $this->Html->script(array('common/respond.min')); ?>
        <?php
    ...
    <body class="login">
        <div class="logo" style="padding: 0;">
            <?php
            echo $this->Html->image('/logo/logo.png', array(
                'alt' => 'LOGO',
                'class' => 'logo-default'
            ));
            ?>
        ...
        <div class="copyright">
            <?php echo date('Y'); ?> &copy; <a href="http://www.grameenphone.com/" target="_blank">Grameenphone.</a>
        </div>
    </body>
</html>
