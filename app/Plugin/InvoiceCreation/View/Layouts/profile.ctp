...
<body class="page-header-fixed page-quick-sidebar-over-content page-full-width page-footer-fixed page-container-bg-solid">
                ...
                <ul class="nav navbar-nav pull-right">
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            <li><?php echo $this->Html->link( '<i class="icon-home"></i> Dashboard', array( 'plugin' => 'invoice_creation', 'controller' => 'users', 'action' => 'dashboard' ), array( 'escape' => FALSE ) ); ?></li>
    ...
    <div class="page-footer">
        <div class="page-footer-inner" style="color: #FFFFFF">
            <?php echo date( 'Y' ) . ' &copy; ' . $this->Html->link( 'Grameenphone Ltd.', 'http://www.grameenphone.com', array( 'target' => '_blank', 'style' => 'color: #FFF;' ) ) . ' ALL Rights Reserved.'; ?>
        </div>
