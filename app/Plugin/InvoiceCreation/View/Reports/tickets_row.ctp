<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <?php echo $this->element( 'tickets/search', array(), array( 'plugin' => 'invoice_creation' ) ); ?>
            </div>
        </div>
        ...
        <?php if( isset( $data ) ) { ?>
            <div class="row">
                <div class="col-md-12">
                    <?php echo $this->element( 'tickets/list', array( 'row' => TRUE ), array( 'plugin' => 'invoice_creation' ) ); ?>
                </div>
            </div>
        <?php } ?>
    </div>
