<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <?php echo $this->element( 'form/tickets/search', array(), array( 'plugin' => 'invoice_creation' ) ); ?>
            </div>
        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        if( empty( $data ) ) {
                                            ...
                                            <div class="btn-group pull-right">
                                                <?php echo $this->Html->link( 'Export to Excel', array( 'plugin' => 'invoice_creation', 'controller' => 'reports', 'action' => 'download_services', '?' => http_build_query( $_REQUEST ) ) ); ?>
                                            </div>
                                            <?php
                                        }
                                        ?>
...
<script type="text/javascript">
    ...
    $( document ).ready( function() {
        ...
        $( '#TicketSubCenter' ).on( 'change', function() {
            ...
            if( subCenterId != '' && subCenterId != 0 && typeof subCenterId != 'undefined' ) {
                ...
                $.ajax( {
                    dataType: 'json',
                    type    : 'POST',
                    url     : '<?php echo Router::url( array( 'plugin' => 'invoice_creation', 'controller' => 'reports', 'action' => 'subCenterSelected' ) ); ?>',
...
//                    dataType: 'json',
//                    type    : 'POST',
//                    url     : '<?php //echo Router::url( array( 'plugin' => 'invoice_creation', 'controller' => 'reports', 'action' => 'siteSelected' ) ); ?>//',
//                    data    : 'site_id=' + siteId,
//                    success : function( data ) {
...
//                    dataType: 'json',
//                    type    : 'POST',
//                    url     : '<?php //echo Router::url( array( 'plugin' => 'invoice_creation', 'controller' => 'reports', 'action' => 'assetGroupSelected' ) ); ?>//',
