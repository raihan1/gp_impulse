        ...
        <div class="portlet box green-sharp">
            ...
            <div class="portlet-body form">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									...
									echo $this->Form->input('region_id', array(
										...
										'class' => 'form-control',
										'minlength' => 2,
										'value' => !empty($data['SubCenter']['region_id']) ? $regionList[$data['SubCenter']['region_id']] : '',
										'placeholder' => 'Region',
										'readonly' => true,
										'data-msg-required' => 'Please provide name'
									));
                ...
                <div class="form-actions right">
                    ...
                    <a href="<?php echo $this->Html->url(array('plugin' => 'invoice_creation', 'controller' => 'users', 'action' => 'dashboard')); ?>" class="btn red"><i class="fa fa-arrow-left"></i> Cancel</a>
                </div>
