 ...
 * Users Controller
 */
class UsersController extends InvoiceCreationAppController {
    
    public $uses = array( 'User', 'Region' );
    ...
    public function dashboard() {
        ...
        $this->set( array(
            'title_for_layout' => 'Invoice Creator Dashboard',
    ...
    public function profile() {
        ...
        $this->set( array(
            ...
            'regionList'       => $this->Region->find( 'list', [ 'contain' => FALSE, 'fields' => 'id, region_name' ] ),
            'title_for_layout' => 'Invoice Creator Profile',
        ) );
    }
}