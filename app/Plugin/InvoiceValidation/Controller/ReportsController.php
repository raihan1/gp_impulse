 ...
 * Reports Controller
 */
class ReportsController extends InvoiceValidationAppController {
    ...
    public function services() {
        ...
        $regions = $this->WarrantyLookup->getRegionList();
        $regionList = array();
    ...
    /**
     * Populate SubCenter dropdown via ajax upon Region selection
     */
    public function regionSelected() {
        $this->autoRender = FALSE;
        $data['SubCenter'] = $this->WarrantyLookup->getSubCenterList( $this->request->data['region_id'] );
    ...
    private function prepareConditions() {
        ...
        if( !empty( $this->request->query['region'] ) ) {
            $conditions['Ticket.region'] = $this->request->query['region'];
        }
