                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="assigned">
                                <div class="table-container">
                                    <?php echo $this->element( 'list/tickets/common', array( 'tableId' => 'assign_tr_table' ), array( 'plugin' => 'invoice_validation' ) ); ?>
                                </div>
                            </div>
                            <div class="tab-pane" id="locked">
                                <div class="table-container">
                                    <?php echo $this->element( 'list/tickets/common', array( 'tableId' => 'locked_tr_table' ), array( 'plugin' => 'invoice_validation' ) ); ?>
                                </div>
                            </div>
                            <div class="tab-pane" id="pending">
                                <div class="table-container">
                                    <?php echo $this->element( 'list/tickets/common', array( 'tableId' => 'pending_tr_table' ), array( 'plugin' => 'invoice_validation' ) ); ?>
                                </div>
                            </div>
                            <div class="tab-pane" id="approved">
                                <div class="table-container">
                                    <?php echo $this->element( 'list/tickets/common', array( 'tableId' => 'approved_tr_table' ), array( 'plugin' => 'invoice_validation' ) ); ?>
                                </div>
                            </div>
                            <div class="tab-pane" id="rejected">
                                <div class="table-container">
                                    <?php echo $this->element( 'list/tickets/common', array( 'tableId' => 'rejected_tr_table' ), array( 'plugin' => 'invoice_validation' ) ); ?>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    var assigned_data_url = '<?php echo $this->Html->url( array( 'plugin' => 'invoice_validation', 'controller' => 'tickets', 'action' => 'data', 'assigned' ) ); ?>';
    var locked_data_url   = '<?php echo $this->Html->url( array( 'plugin' => 'invoice_validation', 'controller' => 'tickets', 'action' => 'data', 'locked' ) ); ?>';
    var pending_data_url  = '<?php echo $this->Html->url( array( 'plugin' => 'invoice_validation', 'controller' => 'tickets', 'action' => 'data', 'pending' ) ); ?>';
    var approved_data_url = '<?php echo $this->Html->url( array( 'plugin' => 'invoice_validation', 'controller' => 'tickets', 'action' => 'data', 'approved' ) ); ?>';
    var rejected_data_url = '<?php echo $this->Html->url( array( 'plugin' => 'invoice_validation', 'controller' => 'tickets', 'action' => 'data', 'rejected' ) ); ?>';
