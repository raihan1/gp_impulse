                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php $i = 0; foreach( $data['TrService'] as $trs ) { ?>
                                            <tr>
                                                ...
                                                <?php if( $type == 'pending' ) { ?>
                                                    ...
                                                    <td><?php echo $trs['current_meter_reading']; ?></td>
                                                    <td><?php echo !empty( $trs['LastService']['current_meter_reading'] ) ? $trs['LastService']['current_meter_reading'] : 'N/A'; ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td<?php echo $type == 'pending' ? ' colspan="7"' : ( $type == 'rejected' ? ' colspan="2"' : '' ); ?>>&nbsp;</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
