        ...
        $( '#TicketSite' ).on( 'change', function() {
            ...
            if( siteId != '' && siteId != 0 && typeof siteId != 'undefined' ) {
                ...
                $.ajax( {
                    dataType: 'json',
                    type    : 'POST',
                    url     : '<?php echo Router::url( array( 'plugin' => 'report_viewer', 'controller' => 'reports', 'action' => 'siteSelected' ) ); ?>',
                    data    : 'site_id=' + siteId,
        ...
        $( document ).on( 'change', '#TicketAssetGroup', function() {
            ...
            if( assetGroupId != '' && assetGroupId != 0 && typeof assetGroupId != 'undefined' ) {
                ...
                $.ajax( {
                    dataType: 'json',
                    type    : 'POST',
                    url     : '<?php echo Router::url( array( 'plugin' => 'report_viewer', 'controller' => 'reports', 'action' => 'assetGroupSelected' ) ); ?>',
