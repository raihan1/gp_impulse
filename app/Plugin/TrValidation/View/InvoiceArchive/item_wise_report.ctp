...
<div id="Report">
    ...
    <table width="100%" border="1" style="margin-bottom: 10px;">
        ...
        <tr>
            ...
            <th><?php echo number_format( $data['InvoiceArchive']['total'], 4 ); ?></th>
            <th>&nbsp;</th>
            <th><?php echo number_format( $data['InvoiceArchive']['vat_total'], 4 ); ?></th>
            <th><?php echo number_format( $data['InvoiceArchive']['total_with_vat'], 4 ); ?></th>
        </tr>
    </table>
