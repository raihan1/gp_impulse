                ...
                <div class="portlet">
                    <div class="portlet-title tabbable-line">
                        <div class="caption">
                            ...
                            <?php echo $this->Html->link( ' <i class="fa fa-upload"></i> <span class="hidden-480">Import Bulk ( <i class="fa fa-file-excel-o"></i> ) Ticket</span>', array( 'plugin' => 'tr_validation', 'controller' => 'tickets', 'action' => 'bulk_import' ), array( 'escape' => FALSE, 'class' => 'btn green' ) ); ?>
                        </div>
