 ...
 * Time: 1:09 PM
 */
class InvoiceArchiveController extends SupplierAppController
{
	...
	public function index()
	{
		$invoiceList = $this->InvoiceArchive->find('list', array(
			'conditions' => array( 'InvoiceArchive.supplier' => $this->loginUser[ 'Supplier' ][ 'name' ], 'InvoiceArchive.status' => APPROVE ),
			'contain' => FALSE,
