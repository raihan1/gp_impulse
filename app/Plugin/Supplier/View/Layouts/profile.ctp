...
//                    ));
                    ?>
                    <h3 style="float: left; height: 100%; margin: 0px; padding: 11px; color: #FFF" id="app-name">GP Warranty</h3>
                </div>
                    ...
                    <ul class="nav navbar-nav pull-right">
                        <li class="dropdown dropdown-user">
                            ...
                            <ul class="dropdown-menu dropdown-menu-default">
                                <li>
                                    <?php echo $this->Html->link('<i class="icon-home"></i> Dashboard', array('plugin' => 'supplier', 'controller' => 'users', 'action' => 'dashboard'), array('escape' => FALSE)); ?>
                                </li>
								<li class="divider"><li>
                                <li>
