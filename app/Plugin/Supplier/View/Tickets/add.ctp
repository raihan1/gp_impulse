                ...
                <div class="form-actions fluid">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <?php echo $this->Html->link( '<i class="fa fa-arrow-left"></i> Cancel', array( 'plugin' => 'supplier', 'controller' => 'tickets', 'action' => 'index', '#' => 'locked' ), array( 'class' => 'btn red', 'escape' => FALSE ) ); ?>
                        </div>
                    </div>
                </div>
