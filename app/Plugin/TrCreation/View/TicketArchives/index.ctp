            ...
            <div class="col-md-12">
                <div class="portlet">
                    <div class="portlet-title tabbable-line">
                        <div class="caption">
                            <span class="caption-subject bold font-yellow-lemon uppercase"><i class="fa fa-ticket"></i> Ticket Archieve List </span>
...
<script type="text/javascript">
    var assigned_data_url = '<?php echo $this->Html->url( array( 'plugin' => 'tr_creation', 'controller' => 'ticket_archives', 'action' => 'data', 'assigned' ) ); ?>';
    var locked_data_url   = '<?php echo $this->Html->url( array( 'plugin' => 'tr_creation', 'controller' => 'ticket_archives', 'action' => 'data', 'locked' ) ); ?>';
    var pending_data_url  = '<?php echo $this->Html->url( array( 'plugin' => 'tr_creation', 'controller' => 'ticket_archives', 'action' => 'data', 'pending' ) ); ?>';
    var approved_data_url = '<?php echo $this->Html->url( array( 'plugin' => 'tr_creation', 'controller' => 'ticket_archives', 'action' => 'data', 'approved' ) ); ?>';
    var rejected_data_url = '<?php echo $this->Html->url( array( 'plugin' => 'tr_creation', 'controller' => 'ticket_archives', 'action' => 'data', 'rejected' ) ); ?>';
