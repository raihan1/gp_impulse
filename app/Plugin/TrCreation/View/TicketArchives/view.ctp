        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    ...
                    <?php echo $this->Html->link( 'Ticket List', array( 'plugin' => 'tr_creation', 'controller' => 'ticket_archives', 'action' => 'index' ) ); ?>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li>
                    <i class="fa fa-ticket"></i>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <dl class="dl-horizontal">
                            <dt>TR No</dt>
                            <dd><?php echo $data['TicketArchive']['id']; ?></dd>
                            
                            <dt>Site Name</dt>
                            <dd><?php echo $data['TicketArchive']['site']; ?></dd>
                            
                            <dt>Asset Group</dt>
                            <dd><?php echo $data['TicketArchive']['asset_group']; ?></dd>
                            
                            <dt>Asset Number</dt>
                            <dd><?php echo $data['TicketArchive']['asset_number']; ?></dd>
                            
                            <dt>TR Class</dt>
                            <dd><?php echo $data['TicketArchive']['tr_class']; ?></dd>
                        </dl>
                    </div>
                    <div class="col-md-6">
                        <dl class="dl-horizontal">
                            <dt>Supplier Name</dt>
                            <dd><?php echo $data['TicketArchive']['supplier']; ?></dd>
                            
                            <dt>TR Creation Date</dt>
                            <dd><?php echo $this->Lookup->showDateTime( $data['TicketArchive']['created'] ); ?></dd>
                            
                            <dt>Received at Supplier</dt>
                            <dd><?php echo $this->Lookup->showDateTime( $data['TicketArchive']['received_at_supplier'] ); ?></dd>
                            
                            <dt>Proposed Completion Date</dt>
                            <dd><?php echo $this->Lookup->showDateTime( $data['TicketArchive']['complete_date'] ); ?></dd>
                            
                            <dt>Comment</dt>
                            <dd><?php echo $data['TicketArchive']['comment']; ?></dd>
                        </dl>
                    </div>
                </div>
