            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-group pull-right">
                        <?php echo $this->Html->link( 'Export to Excel', array( 'plugin' => 'tr_creation', 'controller' => 'reports', 'action' => ( empty( $row ) ? 'export_excel' : 'export_excel_row' ), '?' => http_build_query( $_REQUEST ) ) ); ?>
                    </div>
                </div>
            </div>
        </div>
