        ...
        <div class="portlet box green-sharp">
            ...
            <div class="portlet-body form">
                        ...
                        <div class="col-md-6">
                            <div class="fileinput fileinput-new col-md-9 col-md-offset-3" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                    <?php echo $this->Lookup->showPhoto(!empty($data['User']['image']) ? $data['User']['image'] : '', "/resource/company_{$loginUser['User']['company_id']}/profile_photo/" . $data['User']['image']); ?>
                                </div>
                ...
                <div class="form-actions right">
                    ...
                    <a href="<?php echo $this->Html->url(array('plugin' => 'admin', 'controller' => 'users', 'action' => 'dashboard')); ?>" class="btn red"><i class="fa fa-arrow-left"></i> Cancel</a>
                </div>
