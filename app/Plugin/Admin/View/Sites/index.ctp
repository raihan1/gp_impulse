            ...
            <div class="col-md-12">
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-map-marker"></i>Site List
                        </div>
                        <div class="actions">
                            <?php echo $this->Html->link( '<i class="fa fa-plus"></i> <span class="hidden-480">Add New</span>', array( 'plugin' => 'admin', 'controller' => 'sites', 'action' => 'add' ), array( 'escape' => FALSE, 'class' => 'btn default yellow-stripe' ) ); ?>

                            <?php echo $this->Html->link( ' <i class="fa fa-upload"></i> <span class="hidden-480">Import Bulk ( <i class="fa fa-file-excel-o"></i> ) Site</span>', array( 'plugin' => 'admin', 'controller' => 'sites', 'action' => 'bulk_import' ), array( 'escape' => FALSE, 'class' => 'btn green' ) ); ?>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="table-container">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="site_table">
                                <thead>
...
<script type="text/javascript">
    ...
    $( document ).ready( function() {
        gp_warranty.data_table( 'site_table', '<?php echo $this->Html->url( array( 'plugin' => 'admin', 'controller' => 'sites', 'action' => 'data' ) ); ?>' );
    } );
