            ...
            <div class="col-md-12">
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption"><i class="fa fa-globe"></i> Region List</div>
                        <div class="actions">
                            <?php echo $this->Html->link( '<i class="fa fa-plus"></i> <span class="hidden-480">Add New</span>', array( 'plugin' => 'admin', 'controller' => 'regions', 'action' => 'add' ), array( 'escape' => FALSE, 'class' => 'btn default yellow-stripe' ) ); ?>

                            <?php echo $this->Html->link( ' <i class="fa fa-upload"></i> <span class="hidden-480">Import Bulk ( <i class="fa fa-file-excel-o"></i> ) Region</span>', array( 'plugin' => 'admin', 'controller' => 'regions', 'action' => 'bulk_import' ), array( 'escape' => FALSE, 'class' => 'btn green' ) ); ?>
                        </div>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="region_table">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        <td>&nbsp;</td>
                                        <td><input type="text" name="name" class="form-control form-filter input-sm" /></td>
                                        <td>
...
<script type="text/javascript">
    $( document ).ready( function() {
        gp_warranty.data_table( 'region_table', '<?php echo $this->Html->url( array( 'plugin' => 'admin', 'controller' => 'regions', 'action' => 'data' ) ); ?>' );
    } );
</script>