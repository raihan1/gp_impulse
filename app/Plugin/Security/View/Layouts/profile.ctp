...
<body class="page-header-fixed page-quick-sidebar-over-content page-full-width page-footer-fixed page-container-bg-solid">
    <div class="page-header navbar navbar-fixed-top">
        <div class="page-header-inner">
            <div class="page-logo">
                <h3 style="float: left; height: 100%; margin: 0px; padding: 11px; color: #FFF" id="app-name">Impulse</h3>
            </div>
                ...
                <ul class="nav navbar-nav pull-right">
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            <li>
                                <?php echo $this->Html->link( '<i class="icon-home"></i> Dashboard', array( 'plugin' => 'security', 'controller' => 'users', 'action' => 'dashboard' ), array( 'escape' => FALSE ) ); ?>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <?php echo $this->Html->link( '<i class="fa fa-power-off"></i> Log Out', array( 'plugin' => FALSE, 'controller' => 'users', 'action' => 'logout' ), array( 'escape' => FALSE ) ); ?>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <div class="page-footer">
        <div class="page-footer-inner" style="color: #FFFFFF">
            <?php echo date( 'Y' ); ?> &copy; <a href="http://www.grameenphone.com" target="_blank" style="color: #FFFFFF">Grameenphone.</a>
            ALL Rights Reserved.
        </div>
