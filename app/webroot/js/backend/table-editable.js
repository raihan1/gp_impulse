var TableEditable = function () {
	...
	var handleTable = function () {
		...
		function editRow(oTable, nRow) {
			...
			jqTds[3].innerHTML = '<input type="text" readonly="true" class="form-control input-small" value="' + aData[3] + '">';
			jqTds[4].innerHTML = '<input type="text" readonly="true" class="form-control input-small" value="' + aData[4] + '">';
			jqTds[5].innerHTML = '<input type="text" readonly="true" class="form-control input-small" value="' + aData[5] + '">';
			jqTds[6].innerHTML = '<input type="text" readonly="true" class="form-control input-small" value="' + aData[6] + '">';
