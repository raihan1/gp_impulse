...
class PHPExcel_Reader_Excel5 extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
	...
	const XLS_Type_namePAGE				= 0x0042;
	...
	public function load($pFilename)
	{
		...
		while ($this->_pos < $this->_dataSize) {
			...
			switch ($code) {
				...
				case self::XLS_Type_namePAGE:		$this->_readCodepage();			break;
...
//		$this->_userDefinedProperties = $ole->getUserDefinedProperties();
	...
	private function _readSummaryInformation()
	{
		...
		for ($i = 0; $i < $countProperties; ++$i) {
			...
			switch ($id) {
				case 0x01:	//	Code Page
					$codePage = PHPExcel_Shared_namePage::NumberToName($value);
					break;
...
//		echo '<br />';
	...
	private function _readCodepage()
	{
		...
		$this->_namepage = PHPExcel_Shared_namePage::NumberToName($codepage);
	}
...
//			var_dump($bcBitCount);
	...
	{
		return PHPExcel_Shared_String::ConvertEncoding($string, 'UTF-8', $this->_namepage);
	}
